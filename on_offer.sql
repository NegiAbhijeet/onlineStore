...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2020 at 07:57 AM
...
--
-- Table structure for table `on_offer`
--

CREATE TABLE `on_offer` (
  `id` int(255) NOT NULL,
...
--
-- Dumping data for table `on_offer`
--

INSERT INTO `on_offer` (`id`, `image`, `name`, `price`, `discount_price`, `keyword1`, `keyword2`, `Description`) VALUES
...
--
-- Indexes for table `on_offer`
--
ALTER TABLE `on_offer`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `on_offer`
--
ALTER TABLE `on_offer`
